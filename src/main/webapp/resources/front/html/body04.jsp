...
<div class="header xtop_postive" id="floatXtopBg">
    ...
    <div class="right">
      <ul>
        ...
        <li class="phone">
          ...
          <div class="ph-one"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/weixin.gif"><br>随时看 随地逛</div>
          <div class="navgaline"></div>
        </li>
        <li class="naviga">
  ...
  <div class="in-top-wrap">
    <div class="in-top-t">
      <div class="logo"><!--2016动画开始--><div class="logif"></div><!--2016动画结束--><a href="http://www.shengyuan.cn/"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/logo.jpg"></a></div>
      <div class="rsea">
        <div class="seach">
            ...
            <li class="menus1 per-menu1">
              ...
              <div class="dorpmenu sub-menu1">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=1611" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/272f388b-035c-4d57-a30f-064b1a320e38.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus2 per-menu2">
              ...
              <div class="dorpmenu sub-menu2">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=1267" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/78f26819-7ead-4f63-a1e6-c32ed5a0c187.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus3 per-menu3">
              ...
              <div class="dorpmenu sub-menu3">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=932" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/06d2274b-865a-4e83-819b-989e05bf64da.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus4 per-menu4">
              ...
              <div class="dorpmenu sub-menu4">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=1371" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/1172eacf-2a64-4c8f-8f3b-cc56671e1584.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus5 per-menu5">
              ...
              <div class="dorpmenu sub-menu5">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=897" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/a1c3f7ce-52af-4551-899d-30a1a38a66cc.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus6 per-menu6">
              ...
              <div class="dorpmenu sub-menu6">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=912" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/6fb974e8-da5e-4eed-a913-d104e3f8c7d7.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus7 per-menu7">
              ...
              <div class="dorpmenu sub-menu7">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=921" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/74fedc98-9267-4640-8d09-62bf9779d03a.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus8 per-menu8">
              ...
              <div class="dorpmenu sub-menu8">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=942" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/a5208a3e-0ae9-4a8a-8bef-c512a1a6b3d8.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
            <li class="menus9 per-menu9">
              ...
              <div class="dorpmenu sub-menu9">
                <div class="dorpmenubj">
                  ...
                  <div class="dorpmenu-right"><a href="http://www.shengyuan.cn/product/query.jhtml?pcId=908" target="_blank"><img src="./海淘商城生源保正购 - 海量进口食品尽在生源网上超市_files/baeb72e5-294e-48d8-9387-f266f50fe478.jpg"></a></div>
                  <!---->
                </div>
              </div>
            </li>
