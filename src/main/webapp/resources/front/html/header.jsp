...
<!-- saved from url=(0024)http://www.shengyuan.cn/ -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <meta name="description" content="生源闪购——shengyuan.cn，郴州综合网上超市，在线销售食品、日用、洗护、母婴、家居百货、生鲜、进口食品各类优质商品，闪电送达，逐不出户逛超市，体验网上购物新生活！">
  ...
  <script src="${path}/resources/front/js/hm.js"></script><script src="${path}/resources/front/js/jquery.min.js" type="text/javascript"></script>
