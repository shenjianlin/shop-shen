...
<script type="text/javascript" src="../js/jquert-1.8.3.min.js"></script>
			...
			$.ajax({
				...
				success : function(dd) {
					...
					for (i in d) {
						/*结果是json，是数组对象  */
						var stu = d[i];
						var tr = "<tr><td>" + stu.cid + "</td><td>" + stu.cname + "</td><td>" + stu.cpid + "</td><td>" + stu.cpath + "</td><td><button type='button' class='btn btn-sm btn-success' did='" + stu.cid + "'><img src='../images/laji.png' style='width: 10px;height: 10px;'></button>　<button type='button' class='btn btn-sm btn-info'><img src='../images/qianbi.png' style='width: 10px;height: 10px;'></button></td></tr>";
						$('#tb').append(tr);
					}
					$('#paging').html(dd[1]);
					...
					<thead>
						...
						<tr style="text-align: center">
							<th class="img_sort"><img src="../images/sort_asc.png">
								ID</th>
							<th class="img_sort"><img src="../images/dk.png"> 类别名</th>
							<th class="img_sort"><img src="../images/dk.png"> 父类</th>
							<th class="img_sort"><img src="../images/dk.png"> path</th>
