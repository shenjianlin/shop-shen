					...
					<thead>
						...
						<tr>
							<th class="img_sort"><img src="${path}/resources/back/images/sort_asc.png">
								商品ID</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 商品名称</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 所属类别ID</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 现价</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 原价</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 库存量</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 状态</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 购买量</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 点击量</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 商品图片</th>
							<th class="img_sort"><img src="${path}/resources/back/images/dk.png"> 商品描述</th>
